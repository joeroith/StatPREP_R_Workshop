...
- **Recorder** - shares screen and records answers (share screen can be tasked to someone else if they prefer). <font color='orange'>**Whoever woke up earliest.**</font>
...
# use df_stats() and remember you can split by using |
